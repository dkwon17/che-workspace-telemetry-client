...
class AbstractAnalyticsManagerTest {
  ...
  public void testMergeEventProperties() throws InterruptedException {
    ...
    Map<String, Object> mergedProperties = analyticsManager.getMergeEventProperties(properties);
  ...
  private void clearLastEvent() {
    analyticsManager.lastEventTime = 0L;
    analyticsManager.lastEvent = null;
    analyticsManager.lastIp = null;
    analyticsManager.lastOwnerId = null;
    analyticsManager.lastUserAgent = null;
    analyticsManager.lastResolution = null;
    analyticsManager.lastEventProperties = null;
  }
}
